        ...
        <div className='section relative'>
            <div className='max-w-[1280px] mx-auto'>
                ...
                <div className="relative overflow-hidden flex flex-col items-center md:flex-row justify-center p-6 ">
                    ...
                    <div
                        className={`relative w-80 md:w-72 lg:w-96 p-6 text-left rounded-xl shadow-lg transform transition-transform duration-300 ease-in-out hover:-translate-y-2 -ml-16  bg-[#CBB0EB] rotate-[4deg] translate-y-4`}

                    >
                        <h3 className="text-3xl text-[#1F1738] font-semibold mb-2">Website</h3>
                        <p className=" text-[#1F1738]">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quidem earum eius error placeat consequatur corrupti.</p>

                        <div className='bg-[#1F1738] p-3 rounded-lg mt-4'>
                            <div className='flex justify-between items-center'>
                                <div className='flex gap-1'>
                                    <div className='w-3 h-3 bg-[#CBB0EB] rounded-full'></div>
                                    <div className='w-3 h-3 bg-[#CBB0EB] rounded-full'></div>
                                    <div className='w-3 h-3 bg-[#CBB0EB] rounded-full'></div>
                                </div>
                                <p className='text-[#CBB0EB] text-sm font-medium'>Photography</p>
                            </div>
                            <div className='my-3 w-full h-44 bg-[#CBB0EB] rounded-md'>
