        ...
        <div className='relative bg-transparent  md:-mt-40 md:w-1/2'>
          <div className=''>
            ...
            <div className='flex items-center justify-center md:block'>
              ...
              <a target='_blank' href="https://wa.me/+919599518124" className='bg-gradient-to-r from-purple-900  via-purple-800 to-purple-700  font-russo  text-white md:text-2xl p-2 px-5 flex items-center gap-4 sm:mt-5  md:mt-8 rounded-3xl'>
